          ...
          <form onSubmit={handleSubmit}>
            <VStack spacing={4}>
              ...
              <FormControl>
                ...
                <Select id="type" name="type" value={formik.getFieldProps("type").value} onChange={handleChange} {...getFieldProps("type")} color='black' background='white'>
              ...
              <FormControl isInvalid={errors.comment && touched.comment}>
                ...
                <Textarea
                  ...
                  name="comment"
                  height={250}
                  value={formik.getFieldProps("comment").value} onChange={handleChange}
